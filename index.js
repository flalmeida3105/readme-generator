...
const promptQuestions = () => {
    ...
    return inquirer.prompt([
        ...
        },
        {
            type: "input",
            name: "liveDemo",
            message: "Enter your live demo file's name including extension! (Optional)\n Note: Your file must exists under assets/images.\n\n",
        },
        {
            type: "input",
            name: "installProcess",
            message: `What are the steps required to install your project? (Required)\n\n ####### use <br> to break lines! DO NOT PRESS ENTER until your are done typing! ####### \n Sample: (step 1 <br> Step 2):\n`,
